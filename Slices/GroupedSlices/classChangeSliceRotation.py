...
class Ui_ChangeSliceRotation(object):
    ...
    def setupUi(self, ChangeSliceRotation):
        ...
        self.horizontalSliderX.setRange(-180.0,180.0)
        self.horizontalSliderY.setRange(-180.0,180.0)
        self.horizontalSliderZ.setRange(-180.0,180.0)
    ...
    def changeAxis(self, tag):
        # This condition checks for the axis selected and rotates the three views at the same time and the same degrees 
        if (tag == "X"):
