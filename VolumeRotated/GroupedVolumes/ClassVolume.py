...
class Volume:
    ...
    def displaceVolume(self,displacement,mode):
        ...
        if(mode==SAGITAL):
            translate=displacement-self.center[2]
            self.transform.Translate(0,0,translate*spacing[2])
            self.center[2]=displacement
        elif(mode==AXIAL):
            translate=displacement-self.center[0]
            self.transform.Translate(translate*spacing[0],0,0)
            self.center[0]=displacement
        elif(mode==CORONAL):
            translate=displacement-self.center[1]
            self.transform.Translate(0,translate*spacing[1],0)
            self.center[1]=displacement
